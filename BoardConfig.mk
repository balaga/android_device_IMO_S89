...
-include vendor/IMO/S89/BoardConfigVendor.mk
...
TARGET_BOOTLOADER_BOARD_NAME := S89
...
TARGET_PREBUILT_KERNEL := device/IMO/S89/kernel
BOARD_HAS_NO_SELECT_BUTTON := true
TARGET_RECOVERY_INITRC := device/IMO/S89/recovery/recovery.rc
TARGET_RECOVERY_FSTAB := device/IMO/S89/recovery/recovery.fstab
